...
var Translations = map[string]map[string]string{
	...
	"ct_active_teachers":   {"en": "active teachers", "fr": "enseignants actifs"},
	"ct_per_seat":          {"en": "/teacher/month", "fr": "/enseignant/mois"},
	"ct_billing_info":      {"en": "Billed monthly · each active teacher counts as 1 seat", "fr": "Facturé mensuellement · chaque enseignant actif compte comme 1 place"},
	"ct_add_cost":          {"en": "Adding a teacher increases your monthly invoice by", "fr": "Ajouter un enseignant augmente votre facture mensuelle de"},
	...
	"ct_err_seat_limit":    {"en": "Could not create teacher account.", "fr": "Impossible de créer le compte enseignant."},
	...
	"cd_pending_short":        {"en": "pending requests", "fr": "demandes en attente"},
	"cd_pulse_today_sessions": {"en": "Live sessions", "fr": "Séances live"},
	"cd_pulse_live_today":     {"en": "started today", "fr": "démarrées aujourd'hui"},
	"cd_pulse_submissions":    {"en": "Submissions", "fr": "Devoirs rendus"},
	"cd_pulse_quiz_done":      {"en": "Quizzes done", "fr": "Quiz terminés"},
	"cd_pulse_today":          {"en": "today", "fr": "aujourd'hui"},
	"cd_pulse_attention":      {"en": "Attention required", "fr": "Action requise"},
	"cd_pulse_review":         {"en": "Review", "fr": "Examiner"},
	"cd_pulse_all_clear":      {"en": "All clear", "fr": "Rien à signaler"},
	"cd_teachers_today":       {"en": "Teachers", "fr": "Enseignants"},
	"cd_activity":             {"en": "Activity", "fr": "Activité"},
	"cd_recent":               {"en": "recent", "fr": "récent"},
	"cd_feed_empty":           {"en": "No recent activity yet.", "fr": "Aucune activité récente pour l'instant."},
	"cd_kind_submission":      {"en": "Submitted", "fr": "Rendu"},
	"cd_kind_quiz":            {"en": "Quiz", "fr": "Quiz"},
	"cd_kind_join":            {"en": "Request", "fr": "Demande"},
	"cd_kind_join_desc":       {"en": "applied to", "fr": "veut rejoindre"},
	"cd_kind_live":            {"en": "Live", "fr": "Direct"},
	"cd_kind_live_desc":       {"en": "opened", "fr": "a ouvert"},
	"cd_kind_student":         {"en": "Joined", "fr": "Inscrit"},
	"cd_kind_student_desc":    {"en": "joined", "fr": "a rejoint"},
	...
	// CENTER STUDENT DETAIL (csd_)
	"csd_breadcrumb":        {"en": "Student profile", "fr": "Fiche élève"},
	"csd_classrooms":        {"en": "Classrooms", "fr": "Salles"},
	"csd_sessions":          {"en": "Sessions attended", "fr": "Séances suivies"},
	"csd_quiz_attempts":     {"en": "Quiz attempts", "fr": "Tentatives quiz"},
	"csd_submissions":       {"en": "Submissions", "fr": "Devoirs rendus"},
	"csd_profile_label":     {"en": "PROFILE", "fr": "PROFIL"},
	"csd_profile_title":     {"en": "Edit student", "fr": "Modifier l'élève"},
	"csd_profile_help":      {"en": "Update name, email or phone. Changes apply immediately.", "fr": "Mettez à jour le nom, l'email ou le téléphone. Les modifications sont immédiates."},
	"csd_meta_label":        {"en": "ACTIVITY", "fr": "ACTIVITÉ"},
	"csd_meta_title":        {"en": "Account history", "fr": "Historique du compte"},
	"csd_save_btn":          {"en": "Save changes", "fr": "Enregistrer"},
	"csd_memberships_title": {"en": "Class memberships", "fr": "Salles de classe"},
	"csd_no_memberships":    {"en": "Not assigned to any classroom yet.", "fr": "Aucune affectation pour le moment."},
	"csd_assign_label":      {"en": "Add to classroom", "fr": "Ajouter à une salle"},
	"csd_assign_btn":        {"en": "Add", "fr": "Ajouter"},
	"csd_unassign_btn":      {"en": "Remove from classroom", "fr": "Retirer de la salle"},
	"csd_unassign_confirm":  {"en": "Remove this student from this classroom?", "fr": "Retirer cet élève de cette salle ?"},
	"csd_status":            {"en": "Status", "fr": "Statut"},
	"csd_status_approved":   {"en": "Approved", "fr": "Approuvé"},
	"csd_status_pending":    {"en": "Pending", "fr": "En attente"},
	"csd_status_rejected":   {"en": "Rejected", "fr": "Refusé"},
	"csd_joined_at":         {"en": "Joined", "fr": "Inscrit le"},
	"csd_danger_label":      {"en": "DANGER ZONE", "fr": "ZONE SENSIBLE"},
	"csd_danger_title":      {"en": "Delete student", "fr": "Supprimer l'élève"},
	"csd_danger_help":       {"en": "Permanently removes the student and all their attempts, submissions and attendance records.", "fr": "Supprime définitivement l'élève et toutes ses tentatives, devoirs et présences."},
	"csd_delete_btn":        {"en": "Delete permanently", "fr": "Supprimer définitivement"},
	"csd_delete_confirm":    {"en": "Permanently delete this student and ALL their data? This cannot be undone.", "fr": "Supprimer définitivement cet élève et TOUTES ses données ? Cette action est irréversible."},
	"csd_saved_ok":          {"en": "Changes saved.", "fr": "Modifications enregistrées."},
	"csd_deleted_ok":        {"en": "Student deleted.", "fr": "Élève supprimé."},
	"csd_err_update":        {"en": "Could not save changes.", "fr": "Impossible d'enregistrer les modifications."},
	"csd_err_delete":        {"en": "Could not delete student.", "fr": "Impossible de supprimer l'élève."},

	// CENTER CLASSROOM DETAIL (ccd_)
	"ccd_breadcrumb":        {"en": "Classroom view", "fr": "Vue de la salle"},
	"ccd_open_teacher_view": {"en": "Teacher view", "fr": "Vue enseignant"},
	"ccd_teacher":           {"en": "Teacher", "fr": "Enseignant"},
	"ccd_quizzes":           {"en": "Quizzes", "fr": "Quiz"},
	"ccd_assignments":       {"en": "Assignments", "fr": "Devoirs"},
	"ccd_sessions":          {"en": "Live sessions", "fr": "Séances live"},
	"ccd_students_title":    {"en": "Enrolled students", "fr": "Élèves inscrits"},
	"ccd_no_students":       {"en": "No students enrolled yet.", "fr": "Aucun élève inscrit pour le moment."},
	"ccd_quizzes_title":     {"en": "Quizzes", "fr": "Quiz"},
	"ccd_no_quizzes":        {"en": "No quizzes yet.", "fr": "Aucun quiz pour le moment."},
	"ccd_published":         {"en": "Published", "fr": "Publié"},
	"ccd_draft":             {"en": "Draft", "fr": "Brouillon"},
	...
	// Center owner billing page
	"cb_title":              {"en": "Billing", "fr": "Facturation"},
	"cb_view_all":           {"en": "View invoices", "fr": "Voir les factures"},
	"cb_current_month":      {"en": "Current month estimate", "fr": "Estimation du mois"},
	"cb_next_invoice":       {"en": "Next invoice", "fr": "Prochaine facture"},
	"cb_billed_first_of_month": {"en": "Billed on the 1st", "fr": "Facturée le 1er"},
	"cb_pricing":            {"en": "Price per teacher", "fr": "Tarif par enseignant"},
	"cb_per_active_teacher": {"en": "per active teacher / month", "fr": "par enseignant actif / mois"},
	"cb_invoices_history":   {"en": "Invoice history", "fr": "Historique des factures"},
	"cb_period":             {"en": "Period", "fr": "Période"},
	"cb_teachers":           {"en": "Teachers", "fr": "Enseignants"},
	"cb_amount":             {"en": "Amount", "fr": "Montant"},
	"cb_status":             {"en": "Status", "fr": "Statut"},
	"cb_paid_at":            {"en": "Paid", "fr": "Réglée"},
	"cb_paid":               {"en": "Paid", "fr": "Payée"},
	"cb_unpaid":             {"en": "Unpaid", "fr": "Impayée"},
	"cb_unpaid_count":       {"en": "unpaid invoice(s)", "fr": "facture(s) impayée(s)"},
	"cb_due":                {"en": "due", "fr": "dû"},
	"cb_no_invoices":        {"en": "No invoices yet. The first one will be generated at the end of the month.", "fr": "Aucune facture pour le moment. La première sera générée à la fin du mois."},
	"cb_invoice_help":       {"en": "Invoices are generated monthly based on the number of active teachers in your center. Contact us to settle unpaid invoices.", "fr": "Les factures sont générées chaque mois selon le nombre d'enseignants actifs. Contactez-nous pour régler les factures impayées."},

	// Center owner pending join requests (read-only)
	"cr_title":              {"en": "Pending join requests", "fr": "Demandes d'inscription en attente"},
	"cr_subtitle":           {"en": "Across all teachers in your center", "fr": "Pour tous les enseignants du centre"},
	"cr_student":            {"en": "Student", "fr": "Élève"},
	"cr_teacher":            {"en": "Teacher", "fr": "Enseignant"},
	"cr_classroom":          {"en": "Classroom", "fr": "Salle"},
	"cr_received":           {"en": "Received", "fr": "Reçue"},
	"cr_empty":              {"en": "No pending requests.", "fr": "Aucune demande en attente."},
	"cr_help_owner":         {"en": "Requests are reviewed by the teacher they were sent to. This view is read-only.", "fr": "Les demandes sont traitées par l'enseignant concerné. Cette vue est en lecture seule."},
	...
	"explore_join_rate_limited":   {"en": "You have sent too many requests today. Please try again tomorrow.", "fr": "Vous avez envoyé trop de demandes aujourd'hui. Réessayez demain."},
	...
	"nav_center":            {"en": "Center", "fr": "Centre"},
	"nav_dashboard":         {"en": "Dashboard", "fr": "Tableau de bord"},
	"nav_teachers":          {"en": "Teachers", "fr": "Enseignants"},
	"nav_students":          {"en": "Students", "fr": "Élèves"},
	"nav_classrooms":        {"en": "Classrooms", "fr": "Classes"},
