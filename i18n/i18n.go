...
var Translations = map[string]map[string]string{
	...
	"priv_s2_li1":   {"en": "Teacher applications: name, email, phone, school, wilaya, subject — Legal basis: contract (Art. 6(1)(b)). Retained until account deletion or application rejection + 6 months.", "fr": "Candidatures enseignant : nom, e-mail, téléphone, établissement, wilaya, matière — Base légale : contrat (Art. 6(1)(b)). Conservées jusqu'à la suppression du compte ou le rejet de la candidature + 6 mois."},
