...
func main() {
	...
	platformAdmin := r.Group(platformPath, middleware.PlatformAdminRequired(platformPath))
	{
		...
		platformAdmin.POST("/centers/:id/pricing", h.PlatformCenterUpdatePricing)
		platformAdmin.POST("/centers/:id/generate-invoices", h.PlatformGenerateCenterInvoice)
		platformAdmin.POST("/centers/:id/invoices/:invoiceId/paid", h.PlatformMarkCenterInvoicePaid)
		platformAdmin.POST("/centers/:id/invoices/:invoiceId/cancel", h.PlatformCancelCenterInvoice)
	...
	center := r.Group("/admin/center", middleware.CenterOwnerRequired(s))
	{
		...
		center.POST("/teachers/:id/reset-password", h.CenterResetTeacherPassword)
		...
		center.GET("/students/:id", h.CenterStudentDetail)
		center.POST("/students/:id/update", h.CenterUpdateStudent)
		center.POST("/students/:id/delete", h.CenterDeleteStudent)
		center.POST("/students/:id/unassign", h.CenterUnassignStudent)
		center.POST("/students/:id/assign", h.CenterAssignStudentFromDetail)
		...
		center.GET("/classrooms/:id", h.CenterClassroomDetail)
